package com.anonymous.tests.runner;
...
public class SampleTestRunner extends RobolectricTestRunner {
	...
	public SampleTestRunner(@SuppressWarnings("rawtypes") Class testClass) throws InitializationError {
		super(testClass, new RobolectricConfig(new File("../SolarCalculatorAndroid/AndroidManifest.xml"), new File("../SolarCalculatorAndroid/res")));
	}
}
